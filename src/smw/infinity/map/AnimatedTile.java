...
public class AnimatedTile extends Tile implements Cloneable, Updatable
{
	...
	public AnimatedTile( short tilesetX, short tilesetY, byte tilesetIndex )
	{
		...
		tileImgAnim = ( (AnimatedTileset) Tileset.activeTilesets.get( tilesetIndex ) )
					  .getImageAnim()
					  .getSubanimation( tilesetX * TILE_SIZE, tilesetY * TILE_SIZE, TILE_SIZE, TILE_SIZE );
	...
	{
		super( tilesetX, tilesetY, tilesetIndex, noSet );
	}
