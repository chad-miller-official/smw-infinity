...
{
	public static final int SCENE_WIDTH           = 768;
	...
	protected static final long BASE_TIMER_DELAY = 100;
	...
	protected ScheduledFuture<?> updateLoop;
	protected ScheduledFuture<?> renderLoop;
